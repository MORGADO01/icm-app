...
/**
 * Hook reutilizável para múltiplos contadores.
 * @param {object} valoresIniciais - ex: { adulto: 0, crianca: 0 }
 */
export function useContador(valoresIniciais = {}) {
  ...
  const total = Object.values(contadores).reduce((soma, v) => soma + (v || 0), 0);
